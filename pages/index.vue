      ...
      <div class="row" v-if="currentYQTab == 'Q1'">
        ...
        <div class="col-md-4">
          <YearlyQarterlyCard
            ...
            :units="
              `Units - ${
                forecastYQData[1] ? forecastYQData[1].q1_aggregate : 0
              }`
            "
            :revenue="
              `Revenue - ${
      ...
      <div class="row" v-if="currentYQTab == 'Q2'">
        ...
        <div class="col-md-4">
          <YearlyQarterlyCard
            ...
            :units="
              `Units - ${
                forecastYQData[1] ? forecastYQData[1].q2_aggregate : 0
              }`
            "
            :revenue="
              `Revenue - ${
      ...
      <div class="row" v-if="currentYQTab == 'Q3'">
        ...
        <div class="col-md-4">
          <YearlyQarterlyCard
            ...
            :units="
              `Units - ${
                forecastYQData[1] ? forecastYQData[1].q3_aggregate : 0
              }`
            "
            :revenue="
      ...
      <div class="row" v-if="currentYQTab == 'Q4'">
        ...
        <div class="col-md-4">
          <YearlyQarterlyCard
            ...
            :units="
              `Units - ${
                forecastYQData[1] ? forecastYQData[1].q4_aggregate : 0
              }`
            "
            :revenue="
              `Revenue - ${
